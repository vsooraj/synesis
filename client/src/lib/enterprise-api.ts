...
export interface AnalysisStats {
  ...
  highestScore: number;
  lowestScore: number;
  recentAnalyses: Array<Pick<Analysis, "id" | "jobTitle" | "companyName" | "overallScore" | "summary" | "createdAt">>;
}
...
export const enterpriseApi = {
  ...
  analyses: {
    list: () => req<Array<Pick<Analysis, "id" | "jobTitle" | "companyName" | "overallScore" | "summary" | "createdAt">>>("GET", "/resume/analyses"),
    get: (id: number) => req<Analysis>("GET", `/resume/analyses/${id}`),
    delete: (id: number) => req<void>("DELETE", `/resume/analyses/${id}`),
    analyze: (data: { resumeText: string; jobDescription: string; jobTitle?: string | null; companyName?: string | null }) =>
      req<Analysis>("POST", "/resume/analyze", data),
    stats: () => req<AnalysisStats>("GET", "/resume/stats"),
  },
  resumes: {

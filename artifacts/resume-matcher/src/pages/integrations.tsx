    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">Connect MatchPoint to n8n, Gmail, Outlook, Teams, and your HR systems</p>
        </div>
      </div>
        ...
        <div className="xl:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                MatchPoint will POST signed events to this URL. Use it as a trigger in n8n, Make, Zapier, or any HTTP workflow tool.
              </CardDescription>
            </CardHeader>
              ...
              {configLoading ? (
                ...
                <>
                  ...
                  <div className="flex items-center gap-3 pt-1">
                    ...
                    <Label htmlFor="webhook-enabled" className="text-sm">Active — MatchPoint will deliver events</Label>
                  </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-muted bg-muted/30">
            <CardContent className="pt-4 text-xs text-muted-foreground space-y-2">
              ...
              <p>Every request includes an <code className="bg-muted px-1 rounded">X-MatchPoint-Signature</code> header.</p>
